...
public class C06_TreeMap {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(mp1); //{A=5, C=7, F=3, H=3, T=3}
        ...
        System.out.println(mp1.lowerKey("F")); // C girilen degereden kucuk olan key
        System.out.println(mp1.lowerEntry("G")); // F=3
        ...
        System.out.println(mp1.headMap("K")); //{A=5, C=7, F=3, H=3}


        System.out.println(mp1.headMap("F",true)); //{A=5, C=7, F=3}
        // true dersek girilen deger dahil basa kadar


        System.out.println(mp1.tailMap("F")); //  {F=3, H=3, T=3}
        //

        System.out.println(mp1.tailMap("D")); // {F=3, H=3, T=3}
        System.out.println(mp1.tailMap("F",false)); // {H=3, T=3}
        // false girilen deger dahil degil sona kadar

        System.out.println(mp1.descendingMap()); // {T=3, H=3, F=3, C=7, A=5}
        ...
        System.out.println(mp1); //{C=7, F=3, H=3, T=3}

        System.out.println(mp1.pollLastEntry()); //T=3
        System.out.println(mp1); //{C=7, F=3, H=3}


        System.out.println(mp1.subMap("B", "G")); //{C=7, F=3}

        System.out.println(mp1.subMap("C","H")); // {C=7, F=3}  baslangic inclusive, bitis exclusive

        System.out.println(mp1.subMap("C",false,"H",true)); //{F=3, H=3}
